...
import {
  loadChangeBaseCampModal,
  loadConnectionModal,
} from "../../redux/slices/remoteModalSlice";
...
const SideBar = () => {
  ...
  const orientation = useSelector(
    (state: RootState) => state.language.orientation
  );
  ...
  const handleOpenConnectionModal = async () => {
    ...
    dispatch(storeLog({ key: `onclick_locdata_via_${currentSSID}`, value: ld.payload }));
            ...
            <TouchableWithoutFeedback>
              <Animated.View
                style={[
                  ...
                  orientation === "right" && styles.modalContainerRTL,
                ]}
              >
                <TouchableOpacity
                  style={[
                ...
                <Image
                  source={require("../../assets/images/png/snglogoblack.png")}
                  style={[
                    styles.logo_image,
                    orientation == "right" && styles.logo_imageRTL,
                    { margin: 20 },
                  ]}
                />
                ...
                <View
                  style={[
                    { padding: 10, paddingHorizontal: 20, paddingRight: 30 },
                    orientation === "right" && {
                      paddingRight: 15,
                      paddingLeft: 40,
                    },
                ...
                >
                  <View style={styles.section}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => handleOpenConnectionModal()}
                    >
                      {orientation == "left" && (
                        <MaterialCommunityIcons
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].connect_to_membership}
                      </Text>
                      {orientation == "right" && (
                        <MaterialCommunityIcons
                          name="transit-connection-variant"
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => handleNavigation("AvailableMembership")}
                    >
                      {orientation == "left" && (
                        <AntDesign name="contacts" size={22} color="black" />
                      )}
                      <Text style={styles.link_text}>
                        {translations[language].available_membership}
                      </Text>
                      {orientation === "right" && (
                        <AntDesign name="contacts" size={22} color="black" />
                      )}
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => handleNavigation("MembershipHistory")}
                    >
                      {orientation == "left" && (
                        <MaterialIcons name="history" size={22} color="black" />
                      )}
                      <Text style={styles.link_text}>
                        {translations[language].membership_history}
                      </Text>
                      {orientation == "right" && (
                        <MaterialIcons name="history" size={22} color="black" />
                      )}
                  ...
                  <View style={styles.section}>
                    ...
                    >
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].user_profile}
                      </Text>
                      {orientation == "right" && (
                        <FontAwesome5 name="user" size={18} color="black" />
                      )}
                    ...
                    >
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].lang_settings}
                      </Text>
                      {orientation == "right" && (
                        <Entypo name="language" size={20} color="black" />
                      )}
                    ...
                    >
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].change_mob_number}
                      </Text>
                      {orientation == "right" && (
                        <Entypo name="old-phone" size={20} color="black" />
                      )}
                    ...
                    <TouchableOpacity
                      onPress={handleOpenBaseCampModel}
                      style={[
                        styles.link_option,
                        orientation == "right" && styles.link_option_rtl,
                      ]}
                    >
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].change_service_location}
                      </Text>
                      {orientation == "right" && (
                        <Entypo name="location" size={18} color="black" />
                      )}
                  ...
                  <View style={styles.section}>
                    ...
                    {!isGuest &&<TouchableOpacity
                      ...
                      onPress={() => handleNavigation("LogScreen")}
                    >
                      {orientation == "left" && (
                        <SimpleLineIcons name="docs" size={18} color="black" />
                      )}
                      <Text style={styles.link_text}>
                        {translations[language].logs}
                      </Text>
                      {orientation == "right" && (
                        <Entypo name="location" size={18} color="black" />
                      )}
                    ...
                    >
                      ...
                      <Text style={styles.link_text}>
                        {translations[language].change_pin}
                      </Text>
                      {orientation == "right" && (
                        <MaterialIcons
                          name="password"
