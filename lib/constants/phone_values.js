export const countryCallingCodes = [
  ...
  export function getPhoneNumberLength(countryCode) {
    const phoneLengths = {
      US: 10, // United States
      CA: 10, // Canada
      GB: 10, // United Kingdom
      AE: 9, // United Arab Emirates (Dubai)
      IN: 10, // India
      AU: 10, // Australia
      NZ: 10, // New Zealand
      DE: 10, // Germany
      FR: 10, // France
      BR: 11, // Brazil (includes area code)
      CN: 11, // China (mobile numbers)
      JP: 11, // Japan (mobile numbers)
      IT: 10, // Italy
      RU: 10, // Russia
      SG: 8, // Singapore
      ZA: 10, // South Africa
      PH: 10, // Philippines
      NG: 11, // Nigeria (includes area code)
      MX: 10, // Mexico
      KR: 10, // South Korea
      ID: 10, // Indonesia
      MY: 10, // Malaysia
    ...
    return phoneLengths[countryCode] || 10; // Default to 10 if country code not found
  }
